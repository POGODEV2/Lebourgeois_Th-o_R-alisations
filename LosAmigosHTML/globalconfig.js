...
function renderScoreHud() {
	...
	cubeCountNode.innerText = `CUBE CASSÉS: ${state.game.cubeCount}`;
}
...
function renderMenus() {
	...
	switch (state.menus.active) {
		...
		case MENU_SCORE:
			...
			if (isNewHighScore()) {
				highScoreLblNode.textContent = 'Nouveau Record !';
			} else {
				highScoreLblNode.textContent = `Meilleur score: ${formatNumber(getHighScore())}`;
			}
